...
def cp_defect(file):
    name_extention = file.split('.')[-1]
    if name_extention == 'jpg':
        shutil.copy(file,defect_images)
    if name_extention == 'xml':
        shutil.copy(file,defect_xmls)      
  
def convert_annotation(image_id):
    if probo < 75:
        in_file = open('/home/workspace/PCBBoard/xmls/train2017/%s.xml'%image_id)
        out_file = open('/home/workspace/PCBBoard/labels/train2017/%s.txt'%image_id, 'w')
        ...
        for obj in root.iter('object'):
            cp_defect(image_path)
            cp_defect(annotation_path)
        ...
        in_file = open('/home/workspace/PCBBoard/xmls/val2017/%s.xml'%image_id)
        out_file = open('/home/workspace/PCBBoard/labels/val2017/%s.txt'%image_id, 'w')
...
image_dir = os.path.join(work_space_dir, "extension_images/")
if not os.path.exists(image_dir):
    os.makedirs(image_dir)
clear_hidden_files(image_dir)
annotation_dir = os.path.join(work_space_dir, "extension_xmls/")
...
labels_train = '/home/workspace/PCBBoard/labels/train2017/'
if not os.path.isdir(labels_train):
        os.makedirs(labels_train)
labels_val = '/home/workspace/PCBBoard/labels/val2017/'
...
defect_images = '/home/workspace/PCBBoard/defect_images'
if not os.path.isdir(defect_images):
    os.makedirs(defect_images)
defect_xmls = '/home/workspace/PCBBoard/defect_xml'
if not os.path.isdir(defect_xmls):
    os.makedirs(defect_xmls)
