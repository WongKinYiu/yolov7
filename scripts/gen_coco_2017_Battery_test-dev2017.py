...
test_file = open(os.path.join(work_space_dir, "test-dev2017.txt"), 'w')
# train_file.close()
test_file.close()
...
labels_test = '/home/workspace/BatteryDetect/DataCOCO/labels/test-dev2017/'
...
test_img_dst_path = '/home/workspace/BatteryDetect/DataCOCO/images/test-dev2017/'
if not os.path.isdir(test_img_dst_path):
    os.makedirs(test_img_dst_path)
test_xml_dst_path = '/home/workspace/BatteryDetect/DataCOCO/xmls/test-dev2017/'
...
test_file = open(os.path.join(work_space_dir, "test-dev2017.txt"), 'a')
